...
def checkDate(dateSel, nDays):
    if nDays <= 0:
        ...
        time.sleep(0.2)
        st.toast(f"⚠️ O cálculo foi efetuado para {nDays} dia corrido, as tabelas (junto com os arquivos de download), ")
        time.sleep(0.2)
...
def main():
    ...
    args =  [(dayFirst, nDays, 0, 'contagem em dias corridos', 'demonstrativo único')]
